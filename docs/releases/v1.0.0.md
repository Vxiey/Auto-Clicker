...
- Randomization, burst, fixed-position and multi-point controls are now executed by the Rust clicker instead of being UI-only settings.
- Profile hotkeys now apply active CPS, mouse button, mode, randomization and burst settings directly in the native runtime.
